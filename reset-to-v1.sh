...
sed -i.bak 's|src="/Spider[^"]*"|src="/Spider.png"|' src/components/SpiderImage.jsx
rm src/components/SpiderImage.jsx.bak

# Update SurpriseSpider.jsx back to v1
sed -i.bak 's|src="/spidersspidersspiders[^"]*"|src="/spidersspidersspiders.png"|' src/components/SurpriseSpider.jsx
